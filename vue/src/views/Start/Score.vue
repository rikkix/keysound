<template>
  <div>
    ...
    <div class="mt-5">
      ...
      <table class="border-collapse border border-gray-900 w-full mt-2" v-show="showAnswer">
        <tr v-for="(data,index) in quizInfo.pieces">
          <td class="w-1/12  border border-gray-900">
            {{ index+1 }}
          </td>
          <td class="w-11/12 border border-gray-900">
            {{ data.title }}
          </td>
        </tr>
      </table>
